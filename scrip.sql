-- Command line to import the csv DATA INTO TABLE airline manually
LOAD DATA LOCAL INFILE '/Users/sunday.alabi/SqlProject/ticket.csv'
INTO TABLE ticket
...
alter table ticket drop TicketDate;
